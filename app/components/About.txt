...
const AboutUs: React.FC = () => {
    return (
        <section id="about" className="py-20 bg-gray-100 flex justify-center items-center">
            <div className="container mx-auto px-4">
                <div className="bg-white shadow-md rounded-lg p-8 md:p-12">
                    ...
                    <ul className="text-lg text-left mx-auto max-w-prose list-disc list-inside mt-4">
